...
class LevelDiagnostic(BaseDiagnostic):
    ...
    def _check_floating_actors(self, actors: List[unreal.Actor], result: DiagnosticResult):
        ...
        # Report floating actors with details
        for actor in floating_actors:
            ...
            if origin and extent:
                ...
                details.append(f"Actor bottom Z: {bottom_z:.0f}")
                if nearest_ground:
                    ...
                    if g_origin and g_extent:
                        ...
                        details.append(f"Ground top Z: {ground_top_z:.0f}, Gap: {gap:.0f} units")
            ...
            if actor in actor_info_map:
                ...
                if nearby_supported:
                    ...
                    details.append("No supported actors within 500 units")
