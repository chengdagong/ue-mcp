...
class DiagnosticResult:
    ...
    def print_report(self, verbose: bool = False):
        ...
        unreal.log(self.get_report(verbose=verbose))

    def get_report(self, verbose: bool = False) -> str:
        """
        Generate the diagnostic report as a string.

        Args:
            verbose: If True, include metadata section. If False, include only issues.
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        Convert diagnostic result to a dictionary for JSON serialization.
        ...
        return {
            ...
            "report": self.get_report(verbose=True),
        }
