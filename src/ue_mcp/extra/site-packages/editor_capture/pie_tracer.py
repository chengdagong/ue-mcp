...
"""
    ...
    def _take_screenshot(self, shot_info):
        ...
        try:
            ...
            # Take screenshot
            # force_game_view=False ensures we use our custom camera actor's position/rotation
            # instead of the game camera, which is essential for elevated perspective views
